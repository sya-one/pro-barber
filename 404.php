...
<head>
    ...
    <title>404 - Not Found | The Professional Barbershop</title>
    ...
    <style>
        ...
        .error-container { text-align: center; z-index: 2; }
        .error-code {
            font-size: 8rem;
            font-weight: 700;
            color: #0FA958;
        ...
        .btn-home:hover { background: #0d9147; }
        .floating-icon {
            position: absolute;
            font-size: 3rem;
            opacity: 0.1;
...
<body>
    ...
    <div class="error-container">
        ...
        <div class="message">Looks like we gave you the <strong style="color:#0FA958;">wrong cut</strong>!</div>
        <div class="sub-message">
            This page has vanished like a barber after a bad haircut.<br>
            Don't worry, we'll get you back to looking sharp.
        </div>
